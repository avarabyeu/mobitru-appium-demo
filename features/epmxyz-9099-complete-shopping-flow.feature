Feature: EPMXYZ-9099 - Mobitru E-commerce Mobile App - Complete Shopping Flow
  As a user
  ...
  @epmxyz-9099 @smoke @e2e
  Scenario: Complete shopping flow from login to checkout - EPMXYZ-9099
