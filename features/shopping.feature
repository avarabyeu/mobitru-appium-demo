Feature: E-commerce Mobile App - Complete Shopping Flow
  As a user
  ...
  Scenario: Add product to cart successfully
    When I add product "Samsung Galaxy S20 Ultra 5G 128GB" to cart
    Then the product should be added to cart successfully

  @shopping
  Scenario: Add product with price verification
    When I add product "Samsung Galaxy S20 Ultra 5G 128GB" with price "$1199.99" to cart
    Then the product should be added to cart successfully
